...
function drawBlock(block) {
  ...
  context.drawImage(
    ...
    atlas[block.color].x,
    atlas[block.color].y,
    atlas[block.color].width,
    atlas[block.color].height,
    block.x,
    block.y,
    block.width,
    block.height
...
function drawPlatforma(platforma) {
  ...
  context.drawImage(
    ...
    atlas.platforma.x,
    atlas.platforma.y,
    atlas.platforma.width,
    atlas.platforma.height,
    platforma.x,
    platforma.y,
    platforma.width,
    platforma.height
...
function drawResult() {
    ...
    context.textAlign = "center";
    context. fillText("Для продолжения нажми enter", canvas.width / 2, canvas.height / 2 - 20 );
}